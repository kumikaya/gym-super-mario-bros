...
class SuperMarioBrosRandomStagesEnv(gym.Env):
    ...
    def __init__(self, rom_mode="vanilla", stages=None, render_mode: str | None = None):
        """
        ...
        for world in range(1, 9):
            ...
            for stage in range(1, 5):
                ...
                env = SuperMarioBrosEnv(
                    rom_mode=rom_mode, target=target, render_mode=render_mode
                )
    ...
    def render(self):
        ...
        """
        return SuperMarioBrosEnv.render(self.env)
